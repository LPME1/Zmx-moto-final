      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="text-6xl md:text-8xl font-display uppercase mb-6">ZMX <span className="text-zmx-gold">PARK</span></h1>
            <p className="text-2xl text-zmx-gray max-w-3xl mx-auto">Roulages libres ou encadrés sur circuits MX, SX et Enduro</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div>
              <img src="/zmx_park.png" alt="Vue aérienne du circuit ZMX Park" className="w-full h-96 object-cover border-4 border-zmx-gold rounded-2xl" loading="lazy" />
            </div>
            <div className="flex flex-col justify-center">
              <h2 className="text-4xl font-display uppercase mb-6">Libérez votre <span className="text-zmx-gold">adrénaline</span></h2>
              <p className="text-lg text-zmx-gray mb-6">Profitez de nos circuits professionnels MX, SX et Enduro pour des sessions de roulage libre ou encadré.</p>
              <button onClick={() => setShowCalendar(true)} className="bg-zmx-gold text-zmx-black px-8 py-4 font-bold text-xl uppercase hover:bg-white transition self-start rounded-xl">Réserver ma session</button>
            </div>
          </div>

          <div className="mb-20">
            <h2 className="text-5xl font-display uppercase text-center mb-12">Nos <span className="text-zmx-gold">tarifs</span></h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                <div key={plan.title} className={`glass-card ${plan.popular ? 'border-4' : 'border-2'} border-zmx-gold p-8 text-center relative rounded-2xl`}>
          ...
          <div className="glass-effect border border-zmx-gold/50 p-12 text-center rounded-2xl">
            <h2 className="text-4xl font-display uppercase mb-6">Informations <span className="text-zmx-gold">pratiques</span></h2>
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-8">
              <div className="glass-card border border-zmx-gold/30 p-6 rounded-2xl">
                ...
                <p className="text-zmx-gray">21550 Jancigny · 35 min de Dijon</p>
              </div>
              <div className="glass-card border border-zmx-gold/30 p-6 rounded-2xl">
            ...
            <button onClick={() => setShowCalendar(true)} className="bg-zmx-gold text-zmx-black px-12 py-4 font-bold text-xl uppercase hover:bg-white transition rounded-xl">Réserver maintenant</button>
          </div>
        </div>
      </div>
